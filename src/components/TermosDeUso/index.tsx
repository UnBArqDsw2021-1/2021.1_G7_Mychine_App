...
export const TermosDeUso = () => (
  <>
    <S.Content>
      ...
      <p>
        A sua privacidade é importante para nós. É política do Mychine respeitar
        a sua privacidade em relação a qualquer informação sua que possamos
        coletar no site <a href="https://mychine.vercel.app/">Mychine</a>, e
      ...
      <h2>Política de Cookies Mychine</h2>
      ...
      <p>
        ...
        informação que o Mychine oferece no site e com caráter enunciativo, mas
        não limitativo:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          (softwares) do Mychine, de seus fornecedores ou terceiros, para
      ...
      <p>Esta política é efetiva a partir de October/2021.</p>

      <h1>Termos de Uso</h1>
      <h2>1 - Termos</h2>
      <p>
        Ao acessar ao site Mychine, concorda em cumprir estes termos de serviço,
      ...
      <p>
        ...
        materiais (informações ou software) no site Mychine , apenas para
      ...
      <p>
        ...
        dessas restrições e poderá ser rescindida por Mychine a qualquer
      ...
      <ol>
        <li>
          Os materiais no site da Mychine são fornecidos como estão. Mychine não
        ...
        <li>
          Além disso, o Mychine não garante ou faz qualquer representação
      ...
      <h2>4 - Limitações</h2>
      <p>
        Em nenhum caso o Mychine ou seus fornecedores serão responsáveis ​​por
        ...
        incapacidade de usar os materiais em Mychine, mesmo que Mychine ou um
        representante autorizado da Mychine tenha sido notificado oralmente ou
      ...
      <p>
        Os materiais exibidos no site da Mychine podem incluir erros técnicos,
        tipográficos ou fotográficos. Mychine não garante que qualquer material
        em seu site seja preciso, completo ou atual. Mychine pode fazer
        alterações nos materiais contidos em seu site a qualquer momento, sem
        aviso prévio. No entanto, Mychine não se compromete a atualizar os
        materiais.
      </p>
      <h2>6 - Links</h2>
      <p>
        O Mychine não analisou todos os sites vinculados ao seu site e não é
        responsável pelo conteúdo de nenhum site vinculado. A inclusão de
        qualquer link não implica endosso por Mychine do site. O uso de qualquer
        site vinculado é por conta e risco do usuário.
      </p>
      <h3>Modificações</h3>
      <p>
        O Mychine pode revisar estes termos de serviço do site a qualquer
      ...
      <p>
        ...
        leis do Mychine e você se submete irrevogavelmente à jurisdição
